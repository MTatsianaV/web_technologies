...
$experience = [
    [
        "name" => "старший начальник",
        "startDate" => "2021",
        "finishDate" => "2023",
        "workDescription" => "Руководил начальниками, награждал лучших начальников званиями и благодарнастями за достойную работу!",
    ],
    [
        "name" => "начальник работников",
        "startDate" => "2016",
        "finishDate" => "2020",
        "workDescription" => "Управлял работниками лучше всех. Мой отдел каждый месяц получал звание лучшего отдела!",
    ],
    [
        "name" => "работник",
        "startDate" => "2010",
        "finishDate" => "2015",
        "workDescription" => "Очень хорошо работал свою работу. Каждый месяц получал звание лучшего работника!",
    ],
]
?>
<!DOCTYPE html>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <?php for ($i = 0; $i < count($experience); $i++): ?>
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $experience[$i]['startDate']; ?> - <span
                class="w3-tag w3-teal w3-round"><?= $experience[$i]['finishDate']; ?></span></h6>
            <p><?= $experience[$i]['workDescription']; ?></p>
            <hr>
          </div>
          <?php endfor; ?>
        </div>
